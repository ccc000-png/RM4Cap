...
def parse_opt():
    ...
    parser.add_argument('--CMSA', action='store_true')
    parser.add_argument('--Base', type=int, default=1)
    parser.add_argument('--RFFR', action='store_true')
    parser.add_argument('--fusion_sem', action='store_true')
    parser.add_argument('--fusion_fine', action='store_true')
    ...
    parser.add_argument('--align_objects', type=int, default=3)
...
class TotalConfigs:
    def __init__(self, args):
        ...
        self.RFFR = args.RFFR
        self.fusion_sem = args.fusion_sem
        self.fusion_fine = args.fusion_fine
...
class EncoderConfigs:
    def __init__(self, args):
        ...
        self.align_objects = args.align_objects
...
class TrainingConfigs:
    def __init__(self, args):
        ...
        self.checkpoints_dir = os.path.join(args.checkpoints_dir,
                                     "{}/CMSA_{}_RFFR_{}_{}".format(args.dataset, args.CMSA, args.RFFR, get_timestamp()))
        self.save_checkpoints_path = os.path.join(self.checkpoints_dir,
                                                  '{clip_name}_epochs_{max_epochs}_lr_{lr}_max_objects_{mo}.ckpt'.format(
                                                      ...
                                                      max_epochs=args.align_objects,
                                                      lr=args.lr,
                                                      mo=args.align_objects))
