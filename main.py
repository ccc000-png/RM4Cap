...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('/media/hpc/13CE9BF66AC0DE98/CX/VC/Tracker4Cap/result/checkpoint/msvd/Compose_ablation/clip_l14_epochs_3_lr_0.0002_max_objects_3.ckpt'), strict=False)
    # model.eval()
    # test_fn(cfg, model, test_loader, device)

# --fusion_fine--fusion_sem